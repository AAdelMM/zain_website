...
<section id="aboutUs">
<img class="absolute z-[-5] w-[100vw] h-[auto] left-[0] opacity-80 bg-contain" src="{{asset('images/aboutbg.png')}}" alt="about bg">
<img class="absolute left-[0] z-[-3] w-[100vw] h-[full] opacity-95" src="{{asset('images/aboutcover.png')}}" alt="">
    <div class="container mx-auto mt-[5rem]">
    
        <div class="text-[#26A7C0] flex justify-between w-[8%] text-[0.9rem] items-center">About Us <img class="w-[30%] h-2" src="{{asset('images/arrowL.png')}}" alt=""></div>
        
        <div class="flex justify-between">
            
            <div class="flex flex-col font-extrabold w-[50%] my-5">
                <div class="text-[2.6rem] text-[#034A58]">Where Technology </div>
                <div class="text-[2.6rem] text-[#034A58]">Meets <span class="text-[#26A7C0]">Creativity </span>to Build</div>
                <div class="text-[2.6rem] text-[#034A58]">Innovative Digital Solutions</div>
                <div class="text-[#3B636B] font-normal my-7">ABOUT US  Zain Zwy Information Technology is a leading company specializing in providing  integrated and innovative technology solutions. Founded at the beginning of this  year, we aim to make our mark in the fast-paced world of technology. We offer a  diverse range of tech services that meet our clients' needs and help them achieve  their goals through modern technology.</div>
                <div class="w-[25%] bg-[#26A7C0] text-white text-center py-4">READ MORE</div>
            </div>
        ...
        <img class="absolute right-0 " src="{{asset('images/aboutz.png')}}" alt="z letter">
    </div>
</section>