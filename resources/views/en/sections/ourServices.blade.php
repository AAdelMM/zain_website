<section id="service" class="overflow-hidden">
    <div class="container-fluid mx-auto h-auto md:h-[80rem] mt-[5rem] md:mt-[10rem] relative">
        <!-- Background images -->
        <img class="z-1 w-full md:w-[80%]" src="{{asset('images/servicebg1.png')}}" alt="rectangle1">
        <img class="absolute z-4 bottom-0 w-full h-[50%] md:h-[70%]" src="{{asset('images/servicebg2.png')}}" alt="rectangle2">
        <img class="absolute right-0 top-[-20px] z-[-3] opacity-80 hidden md:block" src="{{asset('images/servicebg3.png')}}" alt="rectangle3">
        ...
        <div class="content absolute top-7 left-0 w-full flex flex-col items-center justify-between">
            <div class="container mx-auto flex flex-col md:flex-row items-center justify-between mt-[2rem] px-5">
                <div class="w-full md:w-[46%] ml-0 md:ml-[4rem] text-center md:text-left">
                    <div class="flex text-[#26A7C0] w-full items-center justify-center md:justify-start mb-5">
                        Our Services <img class="h-2 w-[5%] ml-4" src="{{asset('images/arrowL.png')}}" alt="">
                    </div>
                    <div class="text-[1.8rem] sm:text-[2.4rem] md:text-[2.6rem] font-extrabold text-[#3B636B]">
                        Comprehensive Digital
                    </div>
                    <div class="text-[1.8rem] sm:text-[2.4rem] md:text-[2.6rem] font-extrabold text-[#3B636B]">
                        <span class="text-[#26A7C0]">Solutions </span>for Business Growth
                    </div>
                    <div class="mt-5 text-[#3B636B] text-sm sm:text-base">
            ...
            <div class="cardbody flex flex-col md:flex-row justify-center md:justify-between w-full md:w-[80%] mt-[5rem] md:mt-[10rem] px-5">
                <div class="w-full md:w-[50%] flex flex-col justify-end items-center mb-[-2rem]">
                    <div class="text-center"><img class="w-full md:w-auto" src="{{asset('images/serviceimage.png')}}" alt="service image"></div>
                    <div class="mt-5"><img class="w-full md:w-auto" src="{{asset('images/servicebutton.png')}}" alt="buttons"></div>
                </div>
                <div class="cardcontent w-full md:w-[35%] mt-5 md:mt-0">
