            ...
            <div class="container mx-auto w-[80%] p-8  shadow-xl">
                ...
                <div>
                    <div class="mb-6">
                        ...
                        <textarea id="message" rows="4" placeholder="Write Your Message Here" class="w-full px-3 py-2 placeholder-gray-300 border border-gray-200 rounded-md bg-gray-50 focus:outline-none focus:ring focus:ring-cyan-100 focus:border-cyan-300"></textarea>
                    </div>
                </div>
